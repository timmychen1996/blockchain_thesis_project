...
import './Carrier.sol';*/
import './Product.sol';
import './ProductTransferPseudoRest.sol';
...
contract ProductPseudoRest{
    ...
    ProductTransferPseudoRest ProductTransferInstance;
    constructor(address ProductTransfer_addr) public {
        ProductTransferInstance = ProductTransferPseudoRest( ProductTransfer_addr);
    }
    ...
    string memory receive_time, uint dispatch_amount, uint receive_amount) public {
        ...
        ProductTransferInstance.setProduct(theProductnumber);
